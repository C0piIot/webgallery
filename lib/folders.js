...
// Re-export under the historical public name. The single capability
// heuristic lives in lib/capability.js; this is the same answer.
export { hasFsa as isFsaAvailable };
